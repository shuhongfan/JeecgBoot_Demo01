      ...
      <a-row>
        ...
        <a-col :span="24">
          <a-form-item label="价格" v-bind="validateInfos.price">
            <a-input v-model:value="formData.price" placeholder="请输入价格" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="商品描述" v-bind="validateInfos.spDesc">
            <a-input v-model:value="formData.spDesc" placeholder="请输入商品描述" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="上架日期" v-bind="validateInfos.sjData">
		        <a-date-picker placeholder="请选择上架日期" v-model:value="formData.sjData" value-format="YYYY-MM-DD"  style="width: 100%" :disabled="disabled"/>
          </a-form-item>
        </a-col>
      </a-row>
    </a-form>
...
<script lang="ts" setup>
  ...
  import {loadTreeData, saveOrUpdateDict} from '../TestTree.api';
