<template>
  <div>
    ...
    <!--字典弹窗-->
    <TestTreeModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="test-testTree" setup>
  //ts语法
  import {ref, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import TestTreeModal from './components/TestTreeModal.vue';
  import {columns,searchFormSchema} from './TestTree.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteTestTree, batchDeleteTestTree, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './TestTree.api';
  ...
  async function handleDelete(record) {
    await deleteTestTree({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteTestTree({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
